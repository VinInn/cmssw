...
#ifndef TFCOMPILE_GENERATED___tensorflow_ClusEllipseDim_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED___tensorflow_ClusEllipseDim_H_  // NOLINT(build/header_guard)
...
extern "C" void __tensorflow_ClusEllipseDim(
...
// ClusEllipseDim represents a computation previously specified in a
 ...
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      data->raw_function = __tensorflow_ClusEllipseDim;
  ...
  ClusEllipseDim(AllocMode alloc_mode = AllocMode::ARGS_RESULTS_PROFILES_AND_TEMPS)
      : XlaCompiledCpuFunction(StaticData(), alloc_mode) {}

  ClusEllipseDim(const ClusEllipseDim&) = delete;
  ClusEllipseDim& operator=(const ClusEllipseDim&) = delete;
...
#endif  // TFCOMPILE_GENERATED___tensorflow_ClusEllipseDim_H_
